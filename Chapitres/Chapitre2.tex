...
\begin{itemize}
    ...
    suivre les réservations, valider ou refuser des demandes et accéder 
    aux statistiques.

    \item \textbf{Administrateur :}Une fois authentifié, l'administrateur supervise l'ensemble de la plateforme 
    pour garantir son bon fonctionnement. Il peut gérer les agences, 
    superviser les véhicules et consulter les KPI.
\end{itemize}
...
\vspace{0.2cm}
\noindent\textbf{B. Les besoins fonctionnels de l'acteur "Utilisateur''}
\begin{itemize}
    \item \textbf{S'authentifier :} L'utilisateur doit saisir un login et un mot de 
    passe pour accéder aux fonctionnalités du système.
...
\vspace{0.2cm}
\noindent\textbf{C. Les besoins fonctionnels de l'acteur "Client''}
\begin{itemize}
...
\vspace{0.2cm}
\noindent\textbf{D. Les besoins fonctionnels de l'acteur "Agence''}
\begin{itemize}
    \item \textbf{Gérer vitrine :} L'agence peut publier et mettre à jour les 
    véhicules disponibles dans son espace.
...
\vspace{0.2cm}
\noindent\textbf{E. Les besoins fonctionnels de l'acteur "Administrateur''}
\begin{itemize}
    \item \textbf{Gérer agences :} L’administrateur peut visualiser, ajouter, modifier ou bloquer les agences.
    ...
    \item \textbf{Consulter statistiques :} L’administrateur peut suivre les indicateurs de performance globaux.
\end{itemize}
...
\begin{itemize}[noitemsep, topsep=3pt]
    ...
    \item \textbf{Thème :} nom du cas d'utilisation ou de la fonctionnalité principale.
...
US01 & S'inscrire & Internaute & s'inscrire afin d'accéder aux services & Haute \\ \hline
US02 & Authentification & Utilisateur & m'authentifier afin d'accéder aux fonctionnalités du système & Haute \\ \hline
US03 & Gérer profil & Utilisateur & gérer mon profil afin de modifier mes informations personnelles et préférences & Haute \\ \hline
US04 & Gérer vitrine & Agence & gérer la vitrine afin de publier et mettre à jour les véhicules disponibles & Haute \\ \hline
US05 & Gérer agences & Admin & gérer les agences afin de visualiser, ajouter, modifier ou bloquer les agences & Haute \\ \hline

US06 & Consulter actualités & Internaute & consulter les actualités afin d'accéder aux informations publiées sur la plateforme & Haute \\ \hline
US07 & Contacter administrateur & Internaute & contacter l'administrateur afin d'obtenir plus d'informations & Haute \\ \hline
US08 & Gérer messages & Admin & gérer les messages afin de consulter et répondre aux utilisateurs & Haute \\ \hline

US09 & Effectuer réservation & Client & effectuer une réservation afin de louer un véhicule auprès d'une agence & Moyenne \\ \hline
US10 & Consulter réservations en cours & Client & consulter mes réservations en cours afin de suivre leur état & Moyenne \\ \hline
US11 & Traiter réservations et reclamations & Agence & traiter les réservations et reclamations afin d'accepter/refuser les demandes et gérer les litiges & Moyenne \\ \hline
US12 & Voir score client & Utilisateur & voir mon score client afin de connaître mon indice de fiabilité & Moyenne \\ \hline
US13 & Consulter statistiques-Agence & Agence & consulter les statistiques afin d'analyser les performances & Moyenne \\ \hline
US14 & Consulter statistiques-Admin & Admin & consulter les statistiques globales afin d'analyser les performances du système & Moyenne \\ \hline
US15 & Interagir avec chatbot & Internaute & interagir avec le chatbot afin d'obtenir des réponses automatiques & Moyenne \\ \hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Chapitres/Figures/planification_sprints.png}
    \caption{Sprint 1}
    \label{fig:sprint_1}
\end{figure}
