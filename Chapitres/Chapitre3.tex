...
& & & & Tester. & \\
\hline
\multicolumn{5}{|r|}{\textbf{Estimation Totale (Jours)}} & \textbf{27} \\ \hline
\end{tabular}%
}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Chapitres/Figures/diag_seq_s_inscrire.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Chapitres/Figures/diag_seq_modifier_profil.png}
...
>>>>>>> a2566680d315c3a82fd8829a6bf37246c977c619
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Chapitres/Figures/dia_seq_ajouter_agence.png}
