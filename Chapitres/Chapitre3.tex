...
\cline{5-5}
& & & & Tester. & \\
\multirow{4}{*}{Internaute}
& US01 & S'inscrire 
& S'inscrire afin d'accéder aux services
& Rédiger les spécifications et diagrammes du cas «S'inscrire». & \multirow{4}{*}{7} \\
\cline{5-5}
& & & & Implémenter l'inscription. & \\
\cline{5-5}
& & & & Tester. & \\
...
& Implémenter la gestion des agences. & \multirow{6}{*}{8} \\
\cline{5-5}
& & & & Tester. & \\
\cline{2-6}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Chapitres/Figures/use_case_s1.png}
