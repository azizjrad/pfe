...
\label{Diag_classes_participantes_client_s1}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\textwidth]{Chapitres/Figures/classes_participantes__client_s1.png}
    \caption{Diagramme des classes participantes par acteur Client}
    \label{fig:classes_participantes_client_s1}
\end{figure}
...
Dans le cadre de ce chapitre, nous avons mené le Sprint 1 selon une séquence logique couvrant l'analyse des cas d'utilisation et la conception. La phase suivante concerne la mise en œuvre du Sprint 2, qui est dédié à la gestion des réservations, des réclamations et du tableau de bord.