...
<<<<<<< Updated upstream
{\Large\textbf{Sprint : Gestion des intervenants}}
=======
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Chapitres/Figures/diag_seq_modifier_infos_agences.png}
...
\hline
\multirow{6}{*}{\textbf{Scénario alternatif}} & 6.1 Champs incomplets.\\
& \quad 6.1.1 Le système affiche un message d'erreur. \\
& \quad 6.1.2 Retour à l'étape 5 du scénario nominal. \\
& 6.1 Informations invalides.\\
& \quad 6.1.1 Le système affiche un message d'erreur. \\
& \quad 6.1.2 Retour à l'étape 5 du scénario nominal. \\
\hline
\end{tabular}%
...
\hline
    ...
    & 4.1 Champs incomplets. \\
    & \quad 4.1.1 Le système affiche un message d'erreur. \\
    & 4.2 Données invalides. \\
    & \quad 4.2.1 Le système affiche un message d'erreur. \\
    \hline
\end{tabular}%
}
\end{table}
...
\hline
\multirow{6}{*}{\textbf{Scénario alternatif}} & 5.2 Champs incomplets.\\
& \quad 5.2.1 Le système affiche une message d'erreur. \\
& 5.1 Informations invalides.\\
...
\subsubsection{Diagrammes de séquence détaillé du cas d’utilisation « Modifier profil »}
\label{sec:diag_seq_det_modifier_profil}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Chapitres/figures/diag_seq_det/seq_det_s1/seq_det_modifier_profil.png}
    \caption{Diagramme de séquence détaillé du cas d’utilisation « Modifier profil »}
    \label{fig:seq_det_modifier_profil}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Diagrammes de séquence détaillés de l’acteur Agence}
\label{sec:diag_seq_agence_s1}
\subsubsection{Diagrammes de séquence détaillé du cas d’utilisation « Consulter vitrine »}
\label{sec:diag_seq_det_consulter_vitrine}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Chapitres/figures/diag_seq_det/seq_det_s1/seq_det_consulter_vitrine.png}
    \caption{Diagramme de séquence détaillé du cas d’utilisation « Consulter vitrine »}
    \label{fig:seq_det_consulter_vitrine}
\end{figure}

\subsubsection{Diagrammes de séquence détaillé du cas d’utilisation « Modifier informations voiture »}
\label{sec:diag_seq_det_modifier_infos_voiture}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Chapitres/figures/diag_seq_det/seq_det_s1/seq_det_modifier_infos_voiture.png}
    \caption{Diagramme de séquence détaillé du cas d’utilisation « Modifier informations voiture »}
    \label{fig:seq_det_modifier_infos_voiture}
\end{figure}

\subsubsection{Diagrammes de séquence détaillé du cas d’utilisation « Ajouter voiture »}
\label{sec:diag_seq_det_ajouter_voiture}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Chapitres/figures/diag_seq_det/seq_det_s1/seq_det_ajouter_voiture.png}
    \caption{Diagramme de séquence détaillé du cas d’utilisation « Ajouter voiture »}
    \label{fig:seq_det_ajouter_voiture}
\end{figure}
...
\subsubsection{Diagrammes de séquence détaillé du cas d’utilisation « Consulter agences »}
\label{sec:diag_seq_det_consulter_agences}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Chapitres/figures/diag_seq_det/seq_det_s1/seq_det_consulter_agences.png}
    \caption{Diagramme de séquence détaillé du cas d’utilisation « Consulter agences »}
    \label{fig:seq_det_consulter_agences}
\end{figure}

\subsubsection{Diagrammes de séquence détaillé du cas d’utilisation « Modifier informations agence »}
\label{sec:diag_seq_det_modifier_infos_agence}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Chapitres/figures/diag_seq_det/seq_det_s1/seq_det_modifier_infos_agence.png}
    \caption{Diagramme de séquence détaillé du cas d’utilisation « Modifier informations agence »}
    \label{fig:seq_det_modifier_infos_agence}
\end{figure}
...
\label{sec:diag_seq_det_gerer_messages}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Chapitres/figures/diag_seq_det/seq_det_s1/seq_det_gerer_messages.png}
...
\textbf{Champs} & \textbf{Type} & \textbf{Libellé} & \textbf{Contraintes} \\
\hline
id & bigint(20) & Identifiant unique du véhicule & UNSIGNED, PRIMARY KEY, AUTO\_INCREMENT, NOT NULL \\
\hline
brand & varchar(255) & La marque du véhicule & NOT NULL \\
\hline
model & varchar(255) & Le modèle du véhicule & NOT NULL \\
\hline
year & int(11) & L'année du véhicule & NOT NULL \\
\hline
mileage & int(11) & Le kilométrage du véhicule & NOT NULL \\
\hline
caution\_amount & decimal(10,2) & Le montant de la caution fixé par l'agence & NULLABLE \\
\hline
license\_plate & varchar(255) & La plaque d'immatriculation & NOT NULL, UNIQUE \\
\hline
color & varchar(255) & La couleur du véhicule & NOT NULL \\
\hline
seats & int(11) & Le nombre de places & NOT NULL \\
\hline
transmission & enum('manual','automatic') & Le type de transmission & NOT NULL \\
\hline
fuel\_type & enum('petrol','diesel','electric','hybrid') & Le type de carburant & NOT NULL \\
\hline
status & enum('available','reserved','in\_use','returned') & L'état du véhicule & NOT NULL, DEFAULT available \\
\hline
agency\_id & bigint(20) & Identifiant unique de l'agence & UNSIGNED, FOREIGN KEY, NOT NULL \\
\hline
created\_at & timestamp & Date de création & NULLABLE \\
\hline
updated\_at & timestamp & Date de modification & NULLABLE \\
\hline
images & longtext & Les images du véhicule & utf8mb4\_bin, NULLABLE \\
\hline
\end{tabular}%
}
\end{table}
...
\subsubsection{Tableau « vehicle\_prices »}
\begin{table}[H]
\centering
\caption{Tableau « vehicle\_prices »}
\label{tab:vehicle_prices}
\renewcommand{\arraystretch}{1.3}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|l|l|p{4cm}|l|}
\hline
\textbf{Champs} & \textbf{Type} & \textbf{Libellé} & \textbf{Contraintes} \\
\hline
id & bigint(20) & Identifiant unique & PRIMARY KEY, AUTO\_INCREMENT, NOT NULL \\
\hline
vehicle\_id & bigint(20) & Référence vers le véhicule & FOREIGN KEY (vehicles), NOT NULL \\
\hline
price & decimal(10,2) & Prix appliqué pour la période & NOT NULL \\
\hline
start\_date & date & Début de validité du prix & NULLABLE \\
\hline
end\_date & date & Fin de validité du prix & NULLABLE \\
\hline
\end{tabular}%
}
\end{table}
