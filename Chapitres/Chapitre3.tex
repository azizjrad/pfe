...
\subsubsection{Diagrammes de séquence détaillé du cas d’utilisation « Modifier mot de passe »}
\label{sec:diag_seq_det_modif_mdp}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Chapitres/figures/diag_seq_det/seq_det_s1/seq_det_modif_mdp.png}
    \caption{Diagramme de séquence détaillé du cas d’utilisation « Modifier mot de passe »}
    \label{fig:seq_det_modif_mdp}
\end{figure}

\subsubsection{Diagrammes de séquence détaillé du cas d’utilisation « Modifier informations personnelles »}
\label{sec:diag_seq_det_modif_infos}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Chapitres/figures/diag_seq_det/seq_det_s1/seq_det_modif_infos.png}
    \caption{Diagramme de séquence détaillé du cas d’utilisation « Modifier informations personnelles »}
    \label{fig:seq_det_modif_infos}
\end{figure}

\subsubsection{Diagrammes de séquence détaillé du cas d’utilisation « Consulter voitures »}
\label{sec:diag_seq_det_consulter_voiture}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Chapitres/figures/diag_seq_det/seq_det_s1/seq_det_consulter_voiture.png}
    \caption{Diagramme de séquence détaillé du cas d’utilisation « Consulter voitures »}
    \label{fig:seq_det_consulter_voiture}
\end{figure}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox[c][5cm][c]{0.88\linewidth}{\centering Emplacement réservé pour la capture de l'interface vitrine.}}
