...
\begin{itemize}
    ...
    \item \textbf{Chapitre 3 – Sprint 1 : Gestion des intervenants} : présente le déroulement du premier sprint, incluant la planification et le développement des fonctionnalités de gestion des clients et des administrateurs.
    \item \textbf{Chapitre 4 – Sprint 2 : Gestion des processus des réservations} : détaille la mise en œuvre des fonctionnalités liées aux véhicules, aux réservations et au suivi des paiements.
    \item \textbf{Chapitre 5 – Phase de clôture} : met en lumière les outils et technologies utilisés pour le développement de la plateforme, ainsi que les résultats obtenus.
\end{itemize}
