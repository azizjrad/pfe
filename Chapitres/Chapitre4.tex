...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Chapitres/Figures/diag_seq_det/seq_det_s1/seq_det_gerer_messages.png}
...
\hline
id & bigint(20) & Identifiant unique de la réservation & PRIMARY KEY, AUTO_INCREMENT, NOT NULL \\
\hline
user_id & bigint(20) & Référence vers l'utilisateur (client) & FOREIGN KEY (users), NOT NULL \\
\hline
vehicle_id & bigint(20) & Référence vers le véhicule réservé & FOREIGN KEY (vehicles), NOT NULL \\
\hline
start_date & date & Date de début de la location & NOT NULL \\
\hline
end_date & date & Date de fin de la location & NOT NULL \\
\hline
pickup_location & varchar(255) & Lieu où le client récupère le véhicule & NULLABLE \\
\hline
dropoff\_location & varchar(255) & Lieu de restitution du véhicule & NULLABLE \\
\hline
total\_price & decimal(10,2) & Montant total à payer & NOT NULL \\
\hline
platform\_commission & decimal(10,2) & Commission prélevée par la plateforme & NOT NULL, DEFAULT 0.00 \\
\hline
agency\_payout & decimal(10,2) & Somme versée à l'agence & NOT NULL, DEFAULT 0.00 \\
\hline
status & enum('pending','confirmed','ongoing','completed','cancelled') & Statut de la réservation & NOT NULL, DEFAULT 'pending' \\
\hline
actual\_return\_date & date & Date effective de restitution & NULLABLE \\
\hline
is\_late\_return & tinyint(1) & Indique si le retour est en retard (0 = non, 1 = oui) & NOT NULL, DEFAULT 0 \\
\hline
cancellation\_reason & text & Raison de l'annulation & NULLABLE \\
\hline
notes & text & Remarques supplémentaires & NULLABLE \\
\hline
created\_at & timestamp & Date de création de l'enregistrement & NULLABLE \\
\hline
updated\_at & timestamp & Date de dernière mise à jour & NULLABLE \\
\hline
\end{tabular}%
}
\end{table}
