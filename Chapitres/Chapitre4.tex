...
%\begin{figure}[H]
 %   \centering
  %  \includegraphics[width=0.851\textwidth]{Chapitres/figures/proto_reservation.png}
...
%\begin{figure}[H]
 %   \centering
  %  \includegraphics[width=0.851\textwidth]{Chapitres/figures/proto_dashboard.png}
...
2. L'utilisateur clique sur «Score». \newline
...
\quad 3.1.1 Le système affiche le message «Score non disponible». \newline
...
%\begin{figure}[H]
  %  \centering
   % \includegraphics[width=1\textwidth]{Chapitres/figures/classe_sprint2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{Chapitres/Figures/classes_participantes__utilisateur_s2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Chapitres/Figures/classes_participantes__client_s2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Chapitres/Figures/classes_participantes__agence_s2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Chapitres/Figures/classes_participantes__admin_s2.png}
...
%\begin{figure}[H]
 %   \centering
  %  \includegraphics[width=0.8\textwidth]{Chapitres/figures/cp_client_s2.png}
   % \caption{Diagramme des classes participantes par acteur Client}
...
%\begin{figure}[H]
 %   \centering
  %  \includegraphics[width=0.8\textwidth]{Chapitres/figures/cp_agence_s2.png}
   % \caption{Diagramme des classes participantes par acteur Agence}
...
%\begin{figure}[H]
 %   \centering
  %  \includegraphics[width=0.8\textwidth]{Chapitres/figures/cp_admin_s2.png}
   % \caption{Diagramme des classes participantes par acteur Administrateur}
