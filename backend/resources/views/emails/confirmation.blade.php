...
<html>
  <head>
    ...
    <title>Confirmer le compte - Elite Drive</title>
  </head>
          ...
          <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 6px 18px rgba(20,23,39,0.08)">
            ...
            <tr>
              <td style="padding:28px">
                <h1 style="margin:0 0 8px;font-size:20px;color:#111827">Confirmez votre compte</h1>
                <p style="margin:0 0 18px;color:#374151;line-height:1.5;font-size:15px">Bienvenue{{ isset($name) ? ' ' . e($name) : '' }}{{ isset($role) ? ' (' . e($role) . ')' : '' }} — veuillez confirmer votre adresse e‑mail en cliquant sur le bouton ci‑dessous.</p>

                <div style="text-align:center;margin:24px 0">
                  <a href="{{ $link }}" style="display:inline-block;background:#0066ff;color:#fff;text-decoration:none;padding:12px 22px;border-radius:10px;font-weight:700;box-shadow:0 6px 18px rgba(3,102,214,0.2)">Confirmer mon compte</a>
                </div>
                ...
                <p style="font-size:13px;color:#6b7280">Si vous n'avez pas demandé cette confirmation, ignorez cet e-mail.</p>
              </td>
            </tr>
