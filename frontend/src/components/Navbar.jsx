...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed left-0 right-0 z-50 transition-all duration-700 ${showNavbar ? "translate-y-0" : "-translate-y-full"}`}
    >
          ...
          <div className="relative z-10 w-full px-6 md:px-8">
            ...
            >
              ...
              <div className="hidden md:flex items-center space-x-3 flex-shrink-0 order-3">
                <Link
                  to="/login"
                  className="group relative px-4 py-2.5 rounded-2xl font-medium transition-all duration-500 overflow-hidden text-gray-700 hover:text-primary-600 hover:bg-gray-100/50 hover:backdrop-blur-[16px] hover:shadow-lg hover:scale-105"
                >
        ...
        <>
          ...
          >
            ...
            <div className="relative z-10 flex-1 overflow-y-auto">
              ...
              {/* Action Buttons */}
              <div className="p-6 space-y-3 border-t border-gray-200/50">
                <Link
                  to="/login"
                  className="group relative flex items-center justify-center gap-2 w-full px-6 py-3 text-gray-700 font-medium rounded-xl hover:text-primary-600 hover:bg-gray-100/50 transition-all duration-500 overflow-hidden"
                  onClick={handleCloseSidebar}
                  style={{
                    animation:
                      isMenuOpen && !isClosing
                        ? `slideInFromLeft 0.3s ease-out ${100 + navItems.length * 50}ms both`
                        : "none",
                  }}
                >
                  <svg
                  ...
                  <span className="relative z-10">Connexion</span>
                  <div className="absolute inset-0 bg-gradient-to-b from-white/40 via-white/10 to-transparent opacity-0 group-hover:opacity-100 rounded-xl transition-all duration-500"></div>
                </Link>
