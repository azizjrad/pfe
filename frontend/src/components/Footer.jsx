          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>contact@elitedrive.tn</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-3">
                <a
                  href="#"
                  className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-primary-500 transition-all"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              &copy; 2026 Elite Drive. Tous droits réservés.
            </p>
